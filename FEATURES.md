...
| **PDF scanning** | Detects `/JavaScript`, `/OpenAction`, `/Launch`, `/EmbeddedFile`, URIs, XFA forms, XMP metadata, explicit action lists (`/S /URI`, `/S /Launch`, etc.) and other risky operators via YARA rules |
