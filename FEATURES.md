...
| **Log files** (`.log` Apache CLF · syslog RFC 3164 · syslog RFC 5424 · Zeek TSV) | — | ◐ per-row | — | — (Timeline grid) |
| **JSONL / NDJSON** (`.jsonl` `.ndjson` — newline-delimited JSON) | — | ◐ per-row | — | — (Timeline grid) |
