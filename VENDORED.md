...
| `vendor/highlight.min.js` | Highlight.js **v11.9.0** (core + 35 common languages + `powershell` / `dos` / `vbscript` / `dockerfile` / `nginx` / `apache` / `x86asm` / `properties`) | BSD-3-Clause | `9edbbbabfb0d0c0c9bd1273cb4620e6181a581728234534b4a552296b2716ae3` | https://github.com/highlightjs/highlight.js |
